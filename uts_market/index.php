                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <?php 
                                        ...
                                        if (@$_GET['status']!==NULL) {
                                            ...
                                            elseif($status=='Done'){
                                                echo '<br><br><div class="alert alert-success" role="alert">Data Barang berhasil di-hapus</div>';
                                            }
                                            elseif($status=='Error'){
                                                echo '<br><br><div class="alert alert-danger" role="alert">Data Barang gagal di-hapus</div>';
                                            }
                                        }
                                    ?>
									<h2>Daftar Barang</h2>
                                    <button style="margin-bottom:20px" data-toggle="modal" onclick="window.location.href='input.php';" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Barang</button>
									</div>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($result)){    
												...
												<tr>
													...
													<td><?php echo $p['jumlah_stok'] ?></td>
													<td><?php echo $p['harga_satuan'] ?></td>
                                                    <td>
                                                        <a href="<?php echo "update.php?sku=".$p['sku']; ?>" class="btn btn-outline-warning btn-sm"> Update</a>
                                                        &nbsp;&nbsp;
                                                        <a href="<?php echo "delete.php?sku=".$p['sku']; ?>" class="btn btn-outline-danger btn-sm"> Delete</a>
                                                    </td>    
                                                </tr>                                         
												<?php 
											}
