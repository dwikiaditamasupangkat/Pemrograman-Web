                            ...
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                                        <?php 
                                            if ($status=='OK') {
                                                echo '<br><br><div class="alert alert-success" role="alert">Data Barang berhasil disimpan</div>';
                                            }
                                            elseif($status=='Error'){
                                                echo '<br><br><div class="alert alert-danger" role="alert">Data Barang gagal disimpan</div>';
                                            }
                                        ?>

                                        <h2 style="margin: 30px 0 30px 0;">Form Tambah Data Barang</h2>
                                        <!-- inti dari create -->
                                        <form action="input.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Jumlah Stok" name="jumlah_stok" required="required" pattern="^[0-9]*$">
                                            </div>
                                            <div class="form-group">
                                                <label>Harga Satuan</label>
                                                <input type="text" class="form-control" placeholder="Harga Satuan" name="harga_satuan" required="required"pattern="^[0-9]*$">
                                            </div>
